...
} from "../action-app/workflow-action-app-detail-panel";
import {
...
} from "../catalogs/workflow-action-app-catalog";
import {
...
} from "../catalogs/workflow-tool-catalog";
import {
  HUMAN_REVIEW_SEND_WAIT_CHANNELS,
  type HumanReviewChannelItem,
} from "../catalogs/workflow-human-review-catalog";
import { WORKFLOW_FLOW_NODE_PALETTE } from "../catalogs/workflow-node-palette";
import {
  WORKFLOW_CORE_OTHER,
  WORKFLOW_CORE_POPULAR,
  type WorkflowCoreCatalogItem,
} from "../catalogs/workflow-core-catalog";
import {
  WORKFLOW_FLOW_OTHER,
  WORKFLOW_FLOW_POPULAR,
  type WorkflowFlowCatalogItem,
} from "../catalogs/workflow-flow-catalog";
import {
...
} from "../catalogs/workflow-transform-catalog";
import {
  WORKFLOW_EVALUATION_ACTIONS,
  WORKFLOW_EVALUATION_TRIGGER,
  type WorkflowEvaluationActionId,
} from "../catalogs/workflow-evaluation-node-catalog";
import {
