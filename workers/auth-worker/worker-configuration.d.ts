/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4443878f7cffd094cb3dc0ffe6c244a7)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		VONAGE_API_SECRET: SecretsStoreSecret;
		VONAGE_API_KEY: SecretsStoreSecret;
		VONAGE_AUTH_TOKEN: SecretsStoreSecret;
		ENCRYPTION_SECRET: SecretsStoreSecret;
		GOOGLE_CLIENT_ID: SecretsStoreSecret;
		GOOGLE_CLIENT_SECRET: SecretsStoreSecret;
		APPLE_CLIENT_ID: SecretsStoreSecret;
		APPLE_CLIENT_SECRET: SecretsStoreSecret;
		FACEBOOK_CLIENT_ID: SecretsStoreSecret;
		FACEBOOK_CLIENT_SECRET: SecretsStoreSecret;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACCOUNT_ID" | "SMS_FROM_NUMBER" | "SIWE_DOMAIN" | "FRONTEND_URL" | "BASE_URL" | "DEBUG" | "ENVIRONMENT" | "QUEUE_BATCH_SIZE" | "QUEUE_FLUSH_THRESHOLD" | "QUEUE_FLUSH_INTERVAL" | "MAX_SEND_FAILURE_COUNT" | "RETRY_ALARM_INTERVAL">> {}
}
