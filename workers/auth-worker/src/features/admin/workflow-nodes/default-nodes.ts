...
const SIMPLE_NODES: WorkflowNodeDefinition[] = [
  ...
  builtin({ id: 'core:webhook', runtimeType: 'core', kind: 'webhook', nameKey: 'core_kind_webhook', descriptionKey: 'core_kind_webhook_desc', category: 'trigger', icon: 'Webhook', sections: [{ id: 'input', labelKey: 'section_input', descriptionKey: 'section_input_desc', viewModes: ['json'], fields: [] }, { id: 'parameters', labelKey: 'section_parameters', descriptionKey: 'section_parameters_desc', fields: [{ id: 'label', type: 'text', labelKey: 'field_label', required: true, order: 0 }, { id: 'httpMethod', type: 'select', labelKey: 'field_http_method', defaultValue: 'GET', options: [{ value: 'GET', labelKey: 'opt_http_get' }, { value: 'POST', labelKey: 'opt_http_post' }, { value: 'PUT', labelKey: 'opt_http_put' }, { value: 'DELETE', labelKey: 'opt_http_delete' }], order: 1 }, { id: 'webhookPath', type: 'text', labelKey: 'webhook_path', order: 2 }, { id: 'webhookAuth', type: 'select', labelKey: 'webhook_authentication', defaultValue: 'none', options: [{ value: 'none', labelKey: 'webhook_auth_none' }, { value: 'basic', labelKey: 'webhook_auth_basic' }, { value: 'header', labelKey: 'webhook_auth_header' }, { value: 'jwt', labelKey: 'webhook_auth_jwt' }], order: 3 }, { id: 'webhookRespond', type: 'select', labelKey: 'webhook_respond', defaultValue: 'immediately', options: [{ value: 'immediately', labelKey: 'webhook_respond_immediately' }, { value: 'when_last_node', labelKey: 'webhook_respond_last_node' }, { value: 'respond_node', labelKey: 'webhook_respond_node' }, { value: 'streaming', labelKey: 'webhook_respond_streaming' }], order: 4 }] }, defaultOutputSection(false)] }),
  builtin({ id: 'trigger:webhook', runtimeType: 'trigger', kind: 'webhook', nameKey: 'trigger_kind_webhook', descriptionKey: 'trigger_kind_webhook_desc', category: 'trigger', icon: 'Webhook', sections: [{ id: 'input', labelKey: 'section_input', descriptionKey: 'section_input_desc', viewModes: ['json'], fields: [] }, { id: 'parameters', labelKey: 'section_parameters', descriptionKey: 'section_parameters_desc', fields: [{ id: 'label', type: 'text', labelKey: 'field_label', required: true, order: 0 }, { id: 'httpMethod', type: 'select', labelKey: 'field_http_method', defaultValue: 'GET', options: [{ value: 'GET', labelKey: 'opt_http_get' }, { value: 'POST', labelKey: 'opt_http_post' }, { value: 'PUT', labelKey: 'opt_http_put' }, { value: 'DELETE', labelKey: 'opt_http_delete' }], order: 1 }, { id: 'webhookPath', type: 'text', labelKey: 'webhook_path', order: 2 }, { id: 'webhookAuth', type: 'select', labelKey: 'webhook_authentication', defaultValue: 'none', options: [{ value: 'none', labelKey: 'webhook_auth_none' }, { value: 'basic', labelKey: 'webhook_auth_basic' }, { value: 'header', labelKey: 'webhook_auth_header' }, { value: 'jwt', labelKey: 'webhook_auth_jwt' }], order: 3 }, { id: 'webhookRespond', type: 'select', labelKey: 'webhook_respond', defaultValue: 'immediately', options: [{ value: 'immediately', labelKey: 'webhook_respond_immediately' }, { value: 'when_last_node', labelKey: 'webhook_respond_last_node' }, { value: 'respond_node', labelKey: 'webhook_respond_node' }, { value: 'streaming', labelKey: 'webhook_respond_streaming' }], order: 4 }] }, defaultOutputSection(false)] }),
