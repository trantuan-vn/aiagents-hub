...
export default async function Layout({ children }: LayoutProps<"/dashboard">) {
  ...
  return (
    <SidebarProvider defaultOpen={defaultOpen}>
      ...
      >
        <header className="relative z-20 flex h-12 shrink-0 items-center gap-2 border-b bg-background transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12">
