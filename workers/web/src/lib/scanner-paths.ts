/**
 * Cheap reject for internet-noise probes (phpinfo, WordPress, Joomla, .env, …).
 * Keep in sync with workers/auth-worker/src/shared/scanner-paths.ts.
 * Must never match live Hub prefixes: dashboard, auth, api, marketing pages.
 */
