...
import { BadgeCheck, Bell, CreditCard, LogIn, LogOut, UserPen } from "lucide-react";
              ...
              <DropdownMenuGroup>
                {menuItems.slice(0, -1).map((item) =>
                  "isNotifications" in item && item.isNotifications ? (
                    <DropdownMenuItem key={item.title} onSelect={(e) => e.preventDefault()} className="cursor-pointer">
                      <NotificationBell
                        user={user}
                        size="sm"
