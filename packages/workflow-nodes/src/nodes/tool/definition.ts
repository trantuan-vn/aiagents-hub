...
const SAVE_RAG_FIELDS = [
  ...
  },
  {
    id: "documentIdField",
    type: "text" as const,
    labelKey: "field_document_id_field",
    placeholderKey: "field_document_id_field_placeholder",
    supportsExpression: true,
    order: 3.2,
  },
  {
    id: "contentField",
    type: "text" as const,
    labelKey: "field_content_field",
    placeholderKey: "field_content_field_placeholder",
    supportsExpression: true,
    order: 3.3,
  },
  {
    id: "sourceField",
    type: "text" as const,
    labelKey: "field_source_field",
    placeholderKey: "field_source_field_placeholder",
    supportsExpression: true,
    order: 3.4,
  },
  {
